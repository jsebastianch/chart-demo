...
@Component({
  selector: 'app-kendo-radar-chart',
  templateUrl: './kendo-radar-chart.component.html',
  styleUrls: ['./kendo-radar-chart.component.sass']
})
export class KendoRadarChartComponent implements OnInit {
