...
@Component({
  selector: 'app-kendo-scatter-chart',
  templateUrl: './kendo-scatter-chart.component.html',
  styleUrls: ['./kendo-scatter-chart.component.sass']
})
export class KendoScatterChartComponent implements OnInit {
