...
@Component({
  selector: 'app-kendo-area-chart',
  templateUrl: './kendo-area-chart.component.html',
  styleUrls: ['./kendo-area-chart.component.sass']
})
export class KendoAreaChartComponent implements OnInit {
