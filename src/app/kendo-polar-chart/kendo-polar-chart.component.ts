...
@Component({
  selector: 'app-kendo-polar-chart',
  templateUrl: './kendo-polar-chart.component.html',
  styleUrls: ['./kendo-polar-chart.component.sass']
})
export class KendoPolarChartComponent implements OnInit {
